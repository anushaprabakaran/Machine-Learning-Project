...
%Load Data 
load('DataPreProcessed4.mat');

%Labels
%Training set
trainingSet = AdultDataTrainFinal4AgeEduMS(:,1:3);
%Separating the last label column from training set
trainingLabel = AdultDataTrainFinal4AgeEduMS(:,4:4);
%Test set
testSet = AdultDataTestFinal4AgeEduMS(:,1:3); 
%Separating the last label column from test set
testLabel = AdultDataTestFinal4AgeEduMS(:,4:4);
